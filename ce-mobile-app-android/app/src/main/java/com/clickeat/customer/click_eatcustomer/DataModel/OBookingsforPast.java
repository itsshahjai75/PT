...
public class OBookingsforPast {
    ...
    protected List<OTable> tableData;

    public OBookingsforPast(String id, String bookingDate, Integer numberofPeople, String customerName,
    ...
    public List<OTable> getTableData() {
        return tableData;
    }

    public void setTableData(List<OTable> tableData) {
        this.tableData = tableData;
    }
}
