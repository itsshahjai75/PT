...
public class BookingAdapter extends RecyclerView.Adapter<BookingAdapter.MyViewHolder> {
    ...
    private List<OBookings> bookings;
    ...
    public BookingAdapter(Context mContext, List<OBookings> bookings) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        OBookings datamodel = bookings.get(position);
        holder.mTextView.setText(datamodel.getRestaurantName());
        holder.mTextView.setTypeface(roboto_regular);
...
//                holder.bookingStatus.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_waiting_confirmation3x, 0);
            ...
            tableData = datamodel.getTableList();
