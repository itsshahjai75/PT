...
public class RoomSpinnerAdapter extends ArrayAdapter<String> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<RoomModel> items;
    private final int mResource;

    public RoomSpinnerAdapter(Context context, @LayoutRes int resource, List objects) {
    ...
    public @NonNull View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RoomModel rowItem = items.get(position);
