...
public class TableSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public TableSpinnerAdapter(Context context, @LayoutRes int resource, List objects) {
    ...
    public @NonNull View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        TableModel rowItem = items.get(position);
        ...
        icon.setImageResource(R.drawable.ic_booking_small);
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        names.setText(items.get(position).getName());
        return view;
