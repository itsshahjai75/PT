...
import com.clickeat.restaurant.click_eatrestaurant.DataModel.OTable;
...
import com.clickeat.restaurant.click_eatrestaurant.adapters.RecyclerBookTimeSlotAdapter;
...
public class BookATable extends Activity implements NumberPicker.OnValueChangeListener {
    ...
    private void findIds() {
        ...
        btnCancel = findViewById(R.id.btnBookCancelConfirm);
        textHeader = findViewById(R.id.textHeader);
        recyclerBookTimeSlot = findViewById(R.id.recyclerBookTimeSlot);
        btnBook = findViewById(R.id.btnBookCancelConfirm);
...
//        }
    ...
    private void init() {
        if (intent != null) {
            ...
            textHeader.setText(CONST_SHAREDPREFERENCES.getString(PREF_USER_FULL_NAME,""));
            restaurantId = intent.getStringExtra("restaurantId");
            edtPeople.setText(intent.getStringExtra("people"));
            final String date = convertDateStringToString(intent.getStringExtra("date"),
                    "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'","dd-MMM-yyyy");
            edtDate.setText(date);
            edtMobileNo.setText(intent.getStringExtra("email"));
            edtEmail.setText(intent.getStringExtra("mobile"));
            ...
            String dateTime = edtDate.getText().toString(); // convertDateStringToString(edtDate.getText().toString(),"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'","dd-MMM-yyyy");
...
//                String tableId = spinnerMap.get(Integer.parseInt(spinnerTableNumber.getSelectedItem().toString()));
        ...
        String userId = "";
        /*
            if (SharedData.getIsRemember(BookATable.this) == true)
            userId = SharedData.getUserId(BookATable.this);
        else */
            userId = CONST_SHAREDPREFERENCES.getString(PREF_USER_ID,"");
...
//                Log.d("<>date-", "tableId ==> " + tableId + " date of string ---> " + date.toString() + "name ==> " + name);
    ...
    private void getGridTimeSlots(final String restaurantId, String date) {
        showSpinner();
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Const.SERVER_URL_ONLY)
                .addConverterFactory(ScalarsConverterFactory.create())
